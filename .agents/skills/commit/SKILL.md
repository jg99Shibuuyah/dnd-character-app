...
- **Trailer:** end with the Codex co-author line the harness specifies, e.g.
  `Co-Authored-By: Codex <noreply@anthropic.com>` (use the exact trailer from the current session's instructions if it names a specific model).
